...
class PitchForm(FlaskForm):
	...
	category = RadioField('Label', choices=[ ('passionpitch','passionpitch'), ('interviewpitch','interviewpitch'),('pickuplines','pickuplines'),('newspitch','newspitch')],validators=[Required()])
